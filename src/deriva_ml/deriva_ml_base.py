...
class DerivaML:
    ...
    :attribute hostname: Hostname of the Deriva server.
    :attribute catalog_id: Catalog ID. Either and identifier, or a catalog name.
    :attribute domain_schema: Schema name for domain specific tables and relationships.
    :attribute cache_dir: Directory path for caching data downloaded from the Deriva server as bdbag.
    :attribute working_dir: Directory path for storing data used by or generated by any computations.
    :attribute model_version: A string that indicates the version model.
    :attribute mode: ERMRest model for the catalog
    :attribute pathBuilder: An instance of a datapath pathbuilder object.
    :attribute dataset_table: The ERMrest table that contains datasets in the catalog.
