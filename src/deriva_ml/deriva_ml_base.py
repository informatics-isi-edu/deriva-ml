...
class DerivaML:
    ...
    :ivar hostname: Hostname of the Deriva server.
    ...
    :ivar cache_dir: Directory path for caching data downloaded from the Deriva server as bdbag.
    :ivar working_dir: Directory path for storing data used by or generated by any computations.
    :ivar model_version: A string that indicates the version model.
    :ivar mode: ERMRest model for the catalog
