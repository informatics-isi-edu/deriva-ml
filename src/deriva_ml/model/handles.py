...
# Deriva imports - use importlib to avoid shadowing
import importlib
...
ForeignKey = _ermrest_model.ForeignKey
...
class ColumnHandle:
    ...
    Example:
        Get a column handle and inspect properties::
            ...
            >>> print(col.name)           # "Name"
            >>> print(col.column_type)    # BuiltinTypes.text
    ...
    @property
    def column_type(self) -> BuiltinTypes:
        """Column type as BuiltinTypes enum.

        Returns:
            The column's data type.
        """
        return BuiltinTypes(self._column.type.typename)

    def set_type(self, new_type: BuiltinTypes, apply: bool = True) -> None:
        ...
        """
        type_obj = builtin_types[new_type.value]
        self._column.alter(type=type_obj)
...
class TableHandle:
    ...
    Example:
        ...
        Work with columns::
            ...
            >>> # Add a new column
            >>> new_col = handle.add_column("Status", BuiltinTypes.text, comment="Item status")
    ...
    def add_column(
        ...
        type_obj = builtin_types[column_type.value]
